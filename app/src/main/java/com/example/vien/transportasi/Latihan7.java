...
public class Latihan7 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        soal.setImageResource(R.drawable.soal77);
        piliha = (ImageView) findViewById(R.id.piliha);
        piliha.setImageResource(R.drawable.truk);
        ...
        pilihc.setImageResource(R.drawable.becak);
        pilihd = (ImageView) findViewById(R.id.pilihd);
        pilihd.setImageResource(R.drawable.roket);
    ...
    public void piliha(View v){
        ...
        Latihan7.this.finish();
        Intent latih = new Intent(Latihan7.this, Latihan8.class);
