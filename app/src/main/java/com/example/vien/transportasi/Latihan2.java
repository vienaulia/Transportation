...
public class Latihan2 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        soal.setImageResource(R.drawable.soal22);
        piliha = (ImageView) findViewById(R.id.piliha);
        piliha.setImageResource(R.drawable.pesiar);
    ...
    public void piliha(View v){
        ...
        Latihan2.this.finish();
        Intent latih = new Intent(Latihan2.this, Latihan3.class);
